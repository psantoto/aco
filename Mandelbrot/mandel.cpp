...
int main() {
    ...
    std::cin >> PLOT_NAME;
    PLOT_NAME += ".png";
    double POINTS_PER_DIMENSION_MOD = POINTS_PER_DIMENSION * 0.88; // to get a good plot size
    ...
    gp << "set terminal png size " << POINTS_PER_DIMENSION << "," << POINTS_PER_DIMENSION_MOD << "\n";
